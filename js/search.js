function search() {
  ...
  var yeast = document.getElementById('yeast').value
  var api = ''
  if(name != "" & yeast == ""){
    api = 'https://api.punkapi.com/v2/beers/?beer_name=' + name
  }
  else if (name == "" & yeast != "") {
    api = 'https://api.punkapi.com/v2/beers/?yeast=' + yeast
  }
  else{
    api = 'https://api.punkapi.com/v2/beers/?beer_name=' + name + '&?yeast=' + yeast
  }
  fetch(api)
